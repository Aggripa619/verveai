...
export const metadata: Metadata = {
  title: 'Verve AI — Inventory Management for Shopify & WooCommerce',
  description:
    'AI demand forecasting, multi-location stock management, supplier scorecards, and 10 built-in reports — all in one app for Shopify and WooCommerce merchants.',
  alternates: {
...
export default function HomePage() {
  return (
    <div className="bg-white">
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="order-1 lg:order-2 flex flex-col gap-6">
            <h1 className="text-4xl lg:text-5xl font-bold text-gray-900 leading-tight">
              The Inventory Operating System for Shopify &amp; WooCommerce
            </h1>
            <p className="text-xl lg:text-2xl font-medium text-gray-700 leading-relaxed">
              AI demand forecasting, multi-location stock management, supplier scorecards, and 10 ready-made reports — so you always know what to order, when to order, and why.
            </p>
            <CTAPair />
          </div>
        </div>
      ...
      <section className="py-10 bg-white border-y border-gray-100">
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-2 lg:grid-cols-4 gap-6 text-center">
            {[
              { stat: '10', label: 'Built-In Reports', sub: 'Stock, supplier & sales analytics' },
              { stat: 'Multi-Location', label: 'Stock Management', sub: 'Warehouses, stores & 3PLs' },
              { stat: '$19.99', label: 'Per Month', sub: 'No per-SKU fees, no volume limits' },
      ...
      <section className="py-16" style={{ backgroundColor: 'rgb(245, 245, 245)' }}>
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <h2 className="text-3xl lg:text-4xl font-bold text-gray-900 mb-10">
            Is Your Inventory Still Costing You Thousands?
          </h2>
          <div className="grid md:grid-cols-3 gap-6 text-left mb-10">
            {[
              ...
              <div key={title} className="bg-white rounded-2xl p-6 border border-red-50">
                <div
        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="text-center mb-12 relative">
            ...
            <p className="text-lg max-w-2xl mx-auto" style={{ color: 'rgba(255,255,255,0.6)' }}>
              Verve AI has grown from a forecasting tool into a complete inventory operations platform. Here&apos;s what&apos;s inside.
            </p>
          </div>
      ...
      <section className="py-16" style={{ backgroundColor: 'rgb(245, 245, 245)' }}>
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
          <h2 className="text-3xl font-bold text-center mb-10">With Verve vs. Without</h2>
          <div className="grid md:grid-cols-2 gap-6">
            ...
            <div className="bg-white rounded-2xl p-8 border border-red-50">
              <h3 className="font-bold text-lg mb-4 text-gray-500">❌ Without Verve</h3>
              <ul className="flex flex-col gap-3 text-gray-800">
      ...
      <section className="py-16 bg-white">
        <div className="max-w-2xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-lg text-gray-600 mb-10">One plan. Everything included. No per-SKU fees. No volume limits.</p>
          ...
          <div className="flex flex-col">
            {[
              ...
              },
              {
                ...
                a: '$19.99/month USD. One plan, everything included — no per-SKU charges, no order volume restrictions, no hidden fees.',
              },
              {
                q: 'Can I cancel anytime?',
                a: 'Yes. Cancel directly from your Shopify admin or WordPress dashboard. No notice period, no cancellation fees.',
              },
              {
